...
local plug_map = {
    ...
    ["n|<leader><space>"] = map_cu("Telescope find_files"):with_noremap():with_silent():with_desc(
    ...
    ["n|<leader>sb"] = map_cu("Telescope current_buffer_fuzzy_find"):with_noremap():with_silent():with_desc("Buffer"),
    ["n|<leader>sg"] = map_callback(function()
        require("telescope.builtin").live_grep()
    end):with_noremap():with_silent():with_desc("Buffer"),
