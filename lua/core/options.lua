...
local function load_options()
  local global_local = {
    ...
    fillchars = "eob: ,foldopen:,foldclose:,fold: ,foldsep: ,diff:/",
    foldenable = true,
    foldlevelstart = 99,
    ...
    ruler = true,
    scrolloff = 4,
    sessionoptions = "buffers,curdir,folds,help,tabpages,winpos,winsize,globals,skiprtp",
    ...
    splitkeep = "screen",
    splitright = true,
    statuscolumn = [[%!v:lua.require'modules.utils.ui'.statuscolumn()]],
    startofline = false,
    swapfile = false,
