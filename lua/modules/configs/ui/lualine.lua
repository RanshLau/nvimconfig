return function()
    ...
    local components = {
        ...
        lsp = {
            function()
                ...
                return next(available_servers) == nil and icons.misc.NoActiveLsp or
                           string.format("%s[%s]", icons.misc.LspAvailable, table.concat(available_servers, ", "))
            end,
        ...
        tabwidth = {function()
            return icons.ui.Tab .. vim.api.nvim_get_option_value("tabstop", {
                scope = "local"
            })
        end},
    ...
    require("modules.utils").load_plugin("lualine", {
        ...
        sections = {
            ...
            }, components.file_status, vim.tbl_extend("force", components.separator, {
                cond = function()
            ...
            lualine_y = {components.separator, components.python_venv, components.cwd},
